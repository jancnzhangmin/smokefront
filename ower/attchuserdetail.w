    ...
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" style="background-color:white;" xid="title">
          ...
          <div class="x-titlebar-title" style="font-weight:lighter;color:#808080;"></div>  
          <div class="x-titlebar-right reverse"> 
          </div>
        </div> 
      </div>  
    <div class="x-panel-content x-cards" xid="content1"><div component="$UI/system/components/justep/smartContainer/smartContainer" class="x-smartcontainer" xid="smartContainer1"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="deviceData" style="margin-top:10px;">
   <ul class="x-list-template" xid="listTemplateUl1">
    <li xid="li4" class="list-group-item" style="padding:0px;">
     ...
     <div component="$UI/system/components/justep/row/row" class="x-row" xid="row5">
      ...
      <div class="x-col" xid="col8">
       <span xid="span10" bind-text='val("address")'></span></div> 
  <div class="x-col x-col-fixed text-right" xid="col9" style="width:30px;"><i xid="i2" class="fa fa-trash-o" style="color:#808080;" bind-click="i2Click"></i></div></div> </li> </ul> </div></div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row1">
   <div class="x-col" xid="col7"><a component="$UI/system/components/justep/button/button" class="btn btn-block btn-green" label="绑定设备" xid="button1" onClick="button1Click">
   <i xid="i1"></i>
   <span xid="span1">绑定设备</span></a></div></div>
  </div>
  </div> 
